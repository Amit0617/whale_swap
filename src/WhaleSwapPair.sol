...
contract WhaleSwapPair is WhaleSwapERC20 {
    ...
    // if fee is on, mint liquidity equivalent to the pair of amounts of the first and second tokens
    function _mintFee(
        uint112 _reserve0,
        uint112 _reserve1
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        uint256 totalSupply = totalSupply; // gas savings, must be defined here since totalSupply can be updated
